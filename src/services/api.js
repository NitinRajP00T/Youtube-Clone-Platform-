...
export const commentAPI = {
    getByVideo: (videoId, params) => axiosInstance.get(`/comments`, { params: { ...params, videoId } }), // Actually wait, the route is /api/videos/:videoId/comments or /api/comments?videoId=... Let me use the video nested route
    getByVideoNested: (videoId, params) => axiosInstance.get(`/videos/${videoId}/comments`, { params }),
